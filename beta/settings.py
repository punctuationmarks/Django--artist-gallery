...
SECRET_KEY = 'v_iy)g^zl9fcsju2ehdd1#=n%d6s85hljab#tuh2orsnf5&4_)'
...
# changing the location on where the images are saved
# and where the browser looks for them through Django
